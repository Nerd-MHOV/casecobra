...
const DesignConfigurator = ({
  ...
  const [renderedDimmension, setRedenredDimension] = useState({
  ...
  async function saveConfiguration() {
    ...
    try {
      ...
      ctx?.drawImage(
        ...
        actualX,
        actualY,
        renderedDimmension.width,
        renderedDimmension.height
      );
      ...
      toast({
        ...
        description:
          "There was a problem saving your config, pleate try again.",
        variant: "destructive",
      });
    }
  }
